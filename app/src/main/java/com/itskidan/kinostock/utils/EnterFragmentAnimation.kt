            ...
            while (true) {
                ...
                if (rootView.isAttachedToWindow) {
                    ...
                    activity.runOnUiThread {
                        ...
                        val step = itemCenter * (position * 2 - 1)
                        val x: Int = step
                        ...
                        ViewAnimationUtils.createCircularReveal(rootView,x,y,startRadius,endRadius).apply {
